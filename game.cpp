...
void ClientHandler() {
	...
	while (1) {
		...
		game.player[player_num].x = atoi(msg);
	}
}
...
void LoadGame(GameState *game)
{
	...
	game->player[player_num].x = 220;
	game->player[player_num].y = 140;
...
void DoRender(SDL_Renderer *renderer, GameState* game)
{
	...
	SDL_Rect rect = { game->player[player_num].x, game->player[player_num].y, 100, 100 };
